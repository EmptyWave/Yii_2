...
<div class="task-search">
  ...
  <?= $form->field($model, 'responsible_id',['inputOptions' => ['placeholder' => 'User ID - временно',]])->textInput() ?>

  <?= $form->field($model, 'created')->dropDownList($monthList, ['class' => 'form-control input-md']) ?>
